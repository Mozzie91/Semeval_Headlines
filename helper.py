...
def error_cross_validate(train_data, train_values, model, n_folds=10,
                         shuffle=None, score_function=mean_absolute_error):
...
def top_n_errors(error_res, train_data, train_values, companies, n=50):
...
def error_analysis(data, values, comps, clf, text=False, cv=None, num_errors=500,
